...
namespace Mobile_IP.ViewModels
{
    public class EventCalendarViewModel : BaseViewModel
    {
        ...
        {
            new Event() { Title = "Medicamentatie", Description = "Administrarea medicamentelor prescrise" },
            new Event() { Title = "Consultatie", Description = "Programarea pentru o consultatie medicala" },
            new Event() { Title = "Terapie fizica", Description = "Participarea la sesiunea de terapie fizica" },
            new Event() { Title = "Terapie psihologica", Description = "Participarea la sesiunea de consiliere" },
            new Event() { Title = "Vizita laborator de analize", Description = "Programarea si efectuarea analizelor de sange" },
            new Event() { Title = "Consultatie nutritionist", Description = "Programarea pentru o consultatie cu un nutritionist pentru a discuta despre regimul alimentar recomandat" },
            new Event() { Title = "Vaccinare", Description = "Programarea pentru vaccinare recomandata de medic" },
            new Event() { Title = "Consultatie dentist", Description = "Programare control de rutina dentist" },
